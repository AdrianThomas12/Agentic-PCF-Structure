...
export const opportunityMetadata = {
  ...
  navigation: {
    ...
    msdynmkt_JourneyId_Opportunity: ["mscrm.msdynmkt_journey"],
...
export const enum OpportunityAttributes {
  ...
  msdynmkt_JourneyActionId = "msdynmkt_journeyactionid",
  msdynmkt_JourneyId = "msdynmkt_journeyid",
  msdynmkt_JourneyIdName = "msdynmkt_journeyidname",
  Name = "name",
  Need = "need",
...
export interface Opportunity extends IEntity {
  ...
  */
  ...
  /*
  Journey Action Id StringType The Journey action id in which the opportunity is created.
  */
  msdynmkt_journeyactionid?: string | null;
  /*
  Journey Id LookupType The journey id in which the opportunity is created
  */
  msdynmkt_journeyid?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  msdynmkt_journeyidname?: string | null;
  /*
