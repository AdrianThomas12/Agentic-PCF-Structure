...
export const accountMetadata = {
  ...
  attributeTypes: {
    ...
    msdyn_paymenttermsbasedays: "Integer",
    ...
    msdyn_hasnorelationshiptype: "Optionset",
    msdyn_invoiceaddress: "Optionset",
    msdyn_language: "Optionset",
    msdyn_onholdstatus: "Optionset",
    msdyn_organizationabccode: "Optionset",
  ...
  navigation: {
    ...
    msdyn_defaultvendorpaymentmethodname: ["mscrm.msdyn_vendorpaymentmethod"],
    msdyn_invoicevendoraccount: ["mscrm.msdyn_vendor"],
    msdyn_mappedvendoraccount: ["mscrm.msdyn_vendor"],
    msdyn_partyid: ["mscrm.msdyn_party"],
    msdyn_paymentday: ["mscrm.msdyn_paymentday"],
    msdyn_paymentschedule: ["mscrm.msdyn_paymentschedule"],
    msdyn_paymentterm: ["mscrm.msdyn_paymentterm"],
    ...
    msdyn_vendor: ["mscrm.msdyn_vendor"],
...
export const enum AccountAttributes {
  ...
  msdyn_creditlimitismandatory = "msdyn_creditlimitismandatory",
  msdyn_creditrating = "msdyn_creditrating",
  ...
  msdyn_defaultvendorpaymentmethodname = "msdyn_defaultvendorpaymentmethodname",
  msdyn_defaultvendorpaymentmethodnameName = "msdyn_defaultvendorpaymentmethodnamename",
  ...
  msdyn_hasnorelationshiptype = "msdyn_hasnorelationshiptype",
  msdyn_IdentificationNumber = "msdyn_identificationnumber",
  msdyn_invoiceaddress = "msdyn_invoiceaddress",
  msdyn_invoicevendoraccount = "msdyn_invoicevendoraccount",
  msdyn_invoicevendoraccountName = "msdyn_invoicevendoraccountname",
  msdyn_language = "msdyn_language",
  msdyn_mappedvendoraccount = "msdyn_mappedvendoraccount",
  msdyn_mappedvendoraccountName = "msdyn_mappedvendoraccountname",
  msdyn_namealias = "msdyn_namealias",
  msdyn_onetimecustomer = "msdyn_onetimecustomer",
  msdyn_onholdstatus = "msdyn_onholdstatus",
  msdyn_organizationabccode = "msdyn_organizationabccode",
  msdyn_organizationnumber = "msdyn_organizationnumber",
  msdyn_organizationphoneticname = "msdyn_organizationphoneticname",
  ...
  msdyn_paymenttermName = "msdyn_paymenttermname",
  msdyn_paymenttermsbasedays = "msdyn_paymenttermsbasedays",
  ...
  msdyn_primarylinkedinid = "msdyn_primarylinkedinid",
  ...
  msdyn_vendorknownasname = "msdyn_vendorknownasname",
  msdyn_vendorName = "msdyn_vendorname",
  msdyn_vendororganizationname = "msdyn_vendororganizationname",
...
export interface Account extends IEntity {
  ...
  */
  ...
  /*
  Account Number [Required] StringType Type an ID number or code for the account to quickly search and identify the account in system views.
  */
  ...
  */
  ...
  /*
  Company [Required] LookupType Company
  */
  msdyn_company?: import("dataverse-ify").EntityReference;
  /*
   StringType
  */
  msdyn_companyname?: string | null;
  /*
  Credit Limit Is Mandatory BooleanType Credit Limit Is Mandatory value for the Account. This column maps to the CreditLimitIsManadatory column on the CustCustomerV3Entity in F&O.
  */
  msdyn_creditlimitismandatory?: boolean | null;
  /*
  Credit Rating StringType Credit Rating value for the Account. This column maps to the CreditRating column on the CustCustomerV3Entity in F&O.
  */
  msdyn_creditrating?: string | null;
  /*
  Customer Group Id LookupType The group that the current account is associated with. This column maps to the CustomerGroupId column from the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Customer Payment Method LookupType The Customer Payment Method associated to the Account. This column maps to the PaymentMethod column on the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Methods of Payment LookupType Vendor Methods of Payment
  */
  msdyn_defaultvendorpaymentmethodname?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  msdyn_defaultvendorpaymentmethodnamename?: string | null;
  /*
  Email Description StringType The description for the Email Address 1 value for the account. This column maps to the PrimaryContactEmailDescription in the CustCustomerV3Entity in F&O.
  */
  msdyn_emailaddress1description?: string | null;
  /*
  Fax Description StringType The description for the Fax number for the account. This column maps to the PrimaryContactFaxDescription in the CustCustomerV3Entity in F&O.
  */
  msdyn_faxdescription?: string | null;
  /*
  Fax Extension StringType The Fax Extension associated with the Fax number on the Account table. This column maps to the PrimaryContactFaxExtension column on the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Has No Relationship Type account_msdyn_account_msdyn_hasnorelationshiptype Indicates if the account has any relationship type specified
  */
  msdyn_hasnorelationshiptype?: import("../enums/account_msdyn_account_msdyn_hasnorelationshiptype").account_msdyn_account_msdyn_hasnorelationshiptype | null;
  /*
  Identification Number StringType The Identification Number for government identification for the Account. This column maps to the IdentificationNumber column on the CustCustomerv3Entity in F&O.
  */
  msdyn_identificationnumber?: string | null;
  /*
  Invoice Address msdyn_accountinvoiceaddress Indicates whether an invoice is sent to the Order Account or Invoice Account. This column maps to the InvoiceAddress column on the CustCustomerV3Entity in F&O.
  */
  msdyn_invoiceaddress?: import("../enums/msdyn_accountinvoiceaddress").msdyn_accountinvoiceaddress | null;
  /*
  Invoice Vendor Account LookupType Invoice account of the vendor
  */
  msdyn_invoicevendoraccount?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  msdyn_invoicevendoraccountname?: string | null;
  /*
  Language msdyn_language Default language of vendor
  */
  msdyn_language?: import("../enums/msdyn_language").msdyn_language | null;
  /*
  Linked Vendor Account LookupType Linked vendor account in Vendors table. This column maps vendors in both vendors and Accounts tables in the scenario where vendors need to be created in Accounts table also.
  */
  msdyn_mappedvendoraccount?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  msdyn_mappedvendoraccountname?: string | null;
  /*
  Search Name StringType Search name of the account
  */
  msdyn_namealias?: string | null;
  /*
  Is One Time Customer BooleanType Defines if the Account is a One Time Customer. This column maps to the IsOneTimeCustomer column on the CustCustomerv3Entity in F&O.
  */
  msdyn_onetimecustomer?: boolean | null;
  /*
  On Hold Status msdyn_accountvendorblockedstatus The On Hold Status for the Account. This column maps to the OnHoldStatus column on the CustCustomerv3Entity in F&O.
  */
  msdyn_onholdstatus?: import("../enums/msdyn_accountvendorblockedstatus").msdyn_accountvendorblockedstatus | null;
  /*
  ABC Code msdyn_abccode Organization ABC Code
  */
  msdyn_organizationabccode?: import("../enums/msdyn_abccode").msdyn_abccode | null;
  /*
  Organization Number StringType Organization Number of the party
  */
  msdyn_organizationnumber?: string | null;
  /*
  Organization Phonetic Name StringType Organization Phonetic Name of the account
  */
  msdyn_organizationphoneticname?: string | null;
  /*
  Party Country StringType The Party Country value used for government identification for the Account table. This column maps to the PartyCountry column on the CustCustomerv3Entity in F&O.
  */
  msdyn_partycountry?: string | null;
  /*
  Party ID LookupType Party of the account
  */
  ...
  */
  ...
  /*
  (Deprecated) Party Number StringType Party number for the Account. This field should not be used if Party/GAB solutions are installed
  */
  msdyn_partynumber?: string | null;
  /*
  Party State/Province StringType The Party State/Province used for government identification on the Account. This column maps to the PartyState column on the CustCustomerv3Entity in F&O.
  */
  msdyn_partystateprovince?: string | null;
  /*
  Payment Day LookupType The Payment Day table associated with the Account. This column maps to the PaymentDay column in the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Payment Schedule LookupType The Payment Schedule associated with the Account. This column maps to the PaymentSchedule column in the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Payment Term LookupType The Payment Term associated to the Account. This column maps to the PaymentTerms column on the CustCustomerV3Entity in F&O.
  */
  msdyn_paymentterm?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  msdyn_paymenttermname?: string | null;
  /*
  Payment Terms Base Days IntegerType Payment Terms Base Days for the Account. This column maps to the PaymentTermsBaseDays column in the CustCustomerV3Entity in F&O.
  */
  msdyn_paymenttermsbasedays?: number | null;
  /*
  ...
  */
  ...
  /*
  Primary Contact LookupType Primary Contact of the Account
  */
  ...
  */
  ...
  /*
  (Deprecated) Primary Facebook Description StringType The description for the Primary Facebook ID for the account. This column maps to the PrimaryContactFacebookDescription in the CustCustomerV3Entity in F&O.
  */
  msdyn_primaryfacebookdescription?: string | null;
  /*
  (Deprecated) Primary Facebook ID StringType Primary Facebook ID for the Account. This column maps to the PrimaryContactFacebook column on the CustCustomerV3Entity in F&O.
  */
  msdyn_primaryfacebookid?: string | null;
  /*
  (Deprecated) Primary LinkedIn Description StringType The description for the Primary LinkedIn value for the account. This column maps to the PrimaryContactLinkedInDescription in the CustCustomerV3Entity in F&O.
  */
  ...
  */
  msdyn_primarylinkedinid?: string | null;
  /*
  Primary Time Zone IntegerType Indicates the primary time zone that the client works on.
  */
  msdyn_primarytimezone?: number | null;
  /*
  Primary Twitter ID Description StringType The description for the Primary Twitter ID for the account. This column maps to the PrimaryContactTwitterDescription in the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Sales Tax Group LookupType Unique identifier for Tax Group associated with Account.
  */
  ...
  */
  ...
  /*
  Phone Description StringType The description for the Telephone 1 value for the account. This column maps to the PrimaryContactPhoneDescription in the CustCustomerV3Entity in F&O.
  */
  msdyn_telephone1description?: string | null;
  /*
  Phone Extension StringType The Telephone 1 Extension for the account. This column maps to the PrimaryContactPhoneExtension in the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Vendor LookupType Vendor associated with the Account. This column maps to the VendorAccount column in the CustCustomerV3Entity in F&O.
  */
  msdyn_vendor?: import("dataverse-ify").EntityReference | null;
  /*
  Vendor Created By Workflow BooleanType Indicates if the vendor is created through the workflow
  */
  msdyn_vendorcreatedbyworkflow?: boolean | null;
  /*
  Vendor Group LookupType Vendor Group
  */
  ...
  */
  ...
  /*
  Vendor Known As StringType Vendor Known As Name
  */
  msdyn_vendorknownasname?: string | null;
  /*
   StringType
  */
  msdyn_vendorname?: string | null;
  /*
  Legal Name StringType Vendor Organization Name
  */
  msdyn_vendororganizationname?: string | null;
  /*
  Website Description StringType The description for the Website URL for the account. This column maps to the PrimaryContactURLDescription in the CustCustomerV3Entity in F&O.
  */
  ...
  */
  ...
  /*
  Account Special Instructions MemoType Shows the default instructions to show on new work orders.
  */
  ...
  */
  ...
  /*
  Account Name StringType Type the company or business name.
  */
  name?: string | null;
  /*
  ...
  */
  ...
  /*
  Account Manager OwnerType Enter the user or team who is assigned to manage the record. This field is updated every time the record is assigned to a different user.
  */
  ...
  */
  ...
  /*
  Head Office LookupType This is the ledgered account
  */
  ...
  */
  ...
  /*
  Website StringType http://mtsvm-271/Dashboard/Index/2100
  */
